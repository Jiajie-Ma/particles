...
int main(int argc, char** argv)
{
   ...
   ParticleSystem::GetRenderer().perspective(fov, 1.0f, 0.1f, 100.0f);
   ParticleSystem::GetRenderer().lookAt(vec3(0,0,4), vec3(0,0,0));
   theSystem.init(500, ParticleSystem::GetRenderer().cameraPosition()); // TODO: Set number of particles here
